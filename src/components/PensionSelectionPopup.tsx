...
export function PensionSelectionPopup({
  ...
  return (
    ...
    >
      <div className="relative bg-cream w-full max-w-md max-h-[75vh] overflow-hidden flex flex-col border-[3px] border-ink rounded-[var(--radius-pixel)] shadow-[var(--shadow-pixel-lg)]">
        <button
          onClick={onClose}
        ...
        <h3 className="text-ink text-lg font-bold px-4 pt-4 pb-1 pr-12">Ajouter un pokémon à la pension</h3>
