...
function mapCsvRow(row: CsvRow) {
  return {
    ...
    attaque_11:           row['Attaque 11']?.trim() || null,
    attaque_12:           row['Attaque 12']?.trim() || null,
    attaque_13:           row['Attaque 13']?.trim() || null,
    attaque_14:           row['Attaque 14']?.trim() || null,
    attaque_15:           row['Attaque 15']?.trim() || null,
