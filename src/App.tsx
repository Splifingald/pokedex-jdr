...
export default function App() {
  ...
  // L'écran partagé s'ouvre dans un SECOND onglet, à côté du Pokédex : ça
  // suppose un grand écran. Au téléphone on ne propose donc rien — le joueur y
  // garde son sac et sa fiche, le plateau est sur l'écran de la table.
  ...
  // Aucune invitation à l'ouverture d'une bataille : c'est le bouton
  // « Afficher l'écran » de l'accueil qui sert de porte d'entrée, sans voler le
  // focus à quelqu'un en pleine consultation de son sac.
  const showSessionAnnouncement =
    onlineEnabled && !sessionDismissed && shouldShowSessionAnnouncement(online.state)
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          {activeTab === 'accueil' && (
            <HomeTab
              ...
              onlineAvailable={onlineEnabled && !isMobile}
