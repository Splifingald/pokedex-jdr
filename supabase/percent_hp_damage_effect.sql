-- ============================================================================
-- Migration autonome : nouvel effet special "Degats en % des PV restants"
-- (comme Super Fang / Ultimapoing) sur les capacites de Combat Auto/Manuel.
--
...
-- Suppose que la migration precedente (manual_battle_and_combat_effects.sql)
-- a deja ete appliquee — ce fichier ne fait qu'AJOUTER une colonne et mettre
-- a jour les deux fonctions de resolution de combat.
--
-- Contenu :
--   1. autobattle_ability_rules.percent_hp_damage_percent (1-100, NULL =
--      desactive) — remplace ENTIEREMENT le calcul de degats habituel
--      (base + de + modificateur de stat) par floor(PV actuels de la cible
--      AVANT ce coup x percent_hp_damage_percent / 100). Les degats
--      additionnels conditionnels/contre-coup/soin s'appliquent ensuite
--      normalement sur ce nouveau total.
--   2. autobattle_resolve_battle (mode Auto) mis a jour
--   3. autobattle_resolve_manual_round (mode Manuel) mis a jour
-- ============================================================================
