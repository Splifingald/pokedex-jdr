-- ============================================================================
-- Migration autonome : nouveau comportement de Confusion (comme Sommeil,
-- guerie par un D6 a chaque tour au lieu d'un seul coup) + Peur passe de
-- -3 a -5 de precision, dans autobattle_resolve_battle (Auto) et
-- autobattle_resolve_manual_round (Manuel).
--
-- Aucune nouvelle colonne — juste les deux fonctions de resolution de
-- combat mises a jour dans leur integralite (CREATE OR REPLACE FUNCTION
-- remplace toujours le corps complet). A executer UNE FOIS dans l'editeur
-- SQL Supabase (idempotent, peut etre relance sans risque).
-- ============================================================================
