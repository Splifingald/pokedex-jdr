-- ============================================================================
-- Séquence de capacités adverses (mode Manuel) : limite passée de 4 à 10
-- ============================================================================
-- Ajoute les colonnes opponent_ability_nom_5..10 (les positions 2 à 4
-- existaient déjà). Comme pour _2/_3/_4, elles restent NULL/optionnelles et
-- ignorées en mode Auto — seules les positions non-NULL comptent dans la
...
-- Remplace intégralement autobattle_resolve_manual_round : la construction
-- de la séquence de capacités adverses (v_opponent_ability_sequence) doit
-- désormais lire les 10 positions, pas seulement les 4 premières.
